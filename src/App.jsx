...
const PROJECTS = [
  ...
  { title: "Personal Budgeting App", desc: "Full-stack personal finance tool with 11 modules: income & tax estimation for all 50 states on 2026 IRS brackets (OBBBA SALT phase-out, the new charitable floors, Medicare surtax by filing status), a 50/30/20 budget builder, expense tracking with CSV import, net worth and savings goals, an avalanche-vs-snowball debt planner with amortization, an investment projector with employer-match modelling, FIRE projections with Monte Carlo, and a standard-vs-itemized tax optimizer that feeds back into take-home. Accounts and cloud sync on Supabase with row-level security. 210 assertions run against the shipping calculation engine — no second copy of the maths to drift.", tags: ["Python", "Streamlit", "Supabase", "Personal Finance", "Tax Planning"], status: "Completed", completed: "Apr 2026", updated: "Sep 1, 2026", img: "/projects/budgeting-app.png", url: "https://github.com/masonjbennett/budgeting-app", demo: "https://masonbennett-budget.streamlit.app/" },
