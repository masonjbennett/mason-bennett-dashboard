...
const PROJECTS = [
  ...
  { title: "Personal Budgeting App", desc: "Comprehensive personal finance tool with 11 modules: income & tax estimation (all 50 states, 2026 IRS brackets), 50/30/20 budget builder, expense tracking, net worth monitoring, debt payoff planner (avalanche vs snowball), savings goals, investment projector, FIRE calculator, and tax optimizer. Built for early-career professionals entering the workforce.", tags: ["Python", "Streamlit", "Personal Finance", "Tax Planning"], status: "Completed", url: "https://github.com/masonjbennett/budgeting-app", demo: "https://budgeting-app-dniklqhvxodvndbarpuv3k.streamlit.app/" },
];
const EXPERIENCE = [
