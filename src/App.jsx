...
const PROJECTS = [
  { title: "Filings Terminal", desc: "Type in a ticker and get eight years of a company's financial statements in a few seconds, pulled straight from the reports it files with the SEC. Every figure on the page is clickable — it opens the actual filing that number came from, so anyone can check the work instead of taking it on trust. Nothing is estimated and no AI touches the data. The hard part is that companies don't report in a common format: they label the same line differently from one another, change those labels over the years, and quietly restate old figures. So the tool reads all 10,387 US public companies on their own terms, and rebuilds the sheet around the kind of business it is looking at — a bank, an insurer and a property trust are judged on completely different measures, and each gets the ones analysts actually use. Where a company simply never reported something, it says so plainly rather than guessing. Built and tested against more than fifty real companies.", tags: ["React", "SEC Filings", "Financial Statements", "Serverless"], status: "Live", completed: "Aug 2026", updated: "Aug 12, 2026", img: "/projects/filings-terminal.png", url: "https://github.com/masonjbennett/filings-terminal", demo: "https://filings.masonjbennett.com" },
