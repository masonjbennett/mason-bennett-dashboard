        ...
        <div style={{ ...S.card, background: "linear-gradient(135deg,#f6eee1,#fdf8f0,#f6eee1)", border: "none", borderRadius: 16, position: "relative", overflow: "hidden" }}>
          ...
          <div className="bio-layout" style={{ display: "flex", gap: 28, alignItems: "flex-start", flexWrap: "wrap", position: "relative" }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ color: "#4a443c", fontSize: 14, lineHeight: 1.85, marginBottom: 18 }}>M.S. Finance graduate (May 2026, 4.0 GPA) from the Sam M. Walton College of Business, focused on valuation, transaction analysis, portfolio management, and financial modeling. Pursuing investment banking, private equity, wealth management, and corporate finance roles with hands-on experience in DCF, LBO, and three-statement modeling.</p>
              ...
              <div className="bio-badges" style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 20 }}>
                ...
                <a href="mailto:bennettmasonj@gmail.com" style={{ padding: "10px 22px", borderRadius: 10, background: "#fffdf9", color: "#33302c", fontSize: 12, fontWeight: 600, textDecoration: "none", border: "1px solid #d8c8b0", transition: "all 0.25s" }} onMouseEnter={e => e.currentTarget.style.borderColor = "#0d6d56"} onMouseLeave={e => e.currentTarget.style.borderColor = "#d8c8b0"}>Email Me</a>
              </div>
            </div>
          </div>
        </div>
