      ...
      {tab === "dashboard" && <div>
        ...
        <div className="dash-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 18 }}>
          <section style={{ ...S.card, animation: "fadeUp 0.5s ease 0.08s both", borderTop: "2px solid #34d39940" }}>
            <h2 style={S.cardTitle}><span style={{ color: "#34d399" }}>◆</span> Watchlist<Info text="Live stock prices updated via Finnhub API. Click any ticker to open its TradingView chart. Green = up, red = down from previous close." /></h2>
