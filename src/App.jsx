...
const PROJECTS = [
  ...
  { title: "Personal Budgeting App", desc: "Personal finance planner: a Next.js front end over a Python calculation service. Income and tax estimation for all 50 states on 2026 IRS brackets (OBBBA SALT phase-out, the new charitable floors, Medicare surtax by filing status), a budget builder, expense tracking with bank-CSV import, a calendar-year view, net worth and savings goals, an avalanche-vs-snowball debt planner with amortization, an investment projector with employer-match modelling, and FIRE projections with a Monte Carlo and a savings-rate curve. Accounts and cloud sync on Supabase with row-level security. Every figure is computed server-side from one shared Python engine, with no arithmetic in the front end. 521 assertions and 33 mutation tests run against the shipping engine, plus 225 browser assertions covering every route in both themes.", tags: ["Next.js", "FastAPI", "Python", "Supabase", "Tax Planning"], status: "Completed", completed: "Apr 2026", updated: "Sep 3, 2026", img: "/projects/budgeting-app.png", url: "https://github.com/masonjbennett/budgeting-app", demo: "https://budget.masonjbennett.com" },
      ...
      {tab === "projects" && <div style={{ animation: "fadeUp 0.4s ease both" }}>
        ...
        <div id="portfolio-method" style={{ ...S.card, marginTop: 16 }}>
          ...
          {[
            ...
            ["Minimum variance is not the conservative choice", "GMV never won a set and finished last in two of the three, going negative on cross-asset — where minimizing variance meant holding 95.3% in aggregate bonds going into 2022. Lowest measured risk and lowest realised risk are different claims."],
