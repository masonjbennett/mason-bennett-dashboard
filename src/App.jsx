...
async function callAPI(key, body) { const r = await fetch("https://api.anthropic.com/v1/messages", { method: "POST", headers: apiHeaders(key), body: JSON.stringify(body) }); return r.json(); }
