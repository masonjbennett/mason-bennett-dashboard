      ...
      {tab === "about" && <div style={{ animation: "fadeUp 0.4s ease both", maxWidth: 820 }}>
        ...
        <div style={{ ...S.card, background: "linear-gradient(135deg,#080c16,#0d1828,#0b1120)", border: "none", borderRadius: 16, position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", gap: 28, alignItems: "flex-start", flexWrap: "wrap", position: "relative" }}>
            <img src="/headshot.png" alt="Mason J. Bennett" style={{ width: 180, height: 180, borderRadius: 20, objectFit: "cover", objectPosition: "center 15%", imageRendering: "crisp-edges", filter: "contrast(1.04) brightness(1.02)", WebkitBackfaceVisibility: "hidden", transform: "translateZ(0)", flexShrink: 0, boxShadow: "0 16px 50px rgba(52,211,153,0.2), 0 0 0 2px rgba(52,211,153,0.15), 0 0 60px rgba(52,211,153,0.08)", border: "2px solid #34d39960" }} />
            <div style={{ flex: 1 }}>
        ...
        <div style={{ ...S.card, marginBottom: 14 }}>
          ...
          <div style={{ marginBottom: 14 }}><div style={{ fontSize: 8, color: "#64748b", textTransform: "uppercase", letterSpacing: 2, marginBottom: 8, fontFamily: "JetBrains Mono, monospace" }}>Core Finance</div><div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>{["Financial Modeling", "Valuation (DCF, LBO, Comps)", "Investment Analysis", "Transaction Analysis", "Portfolio Management", "Econometrics", "Regression Analysis", "Quantitative Research"].map(s => <span key={s} style={{ fontSize: 11, padding: "5px 12px", borderRadius: 6, background: "#34d39908", color: "#34d399", border: "1px solid #34d39912" }}>{s}</span>)}</div></div>
          <div><div style={{ fontSize: 8, color: "#64748b", textTransform: "uppercase", letterSpacing: 2, marginBottom: 8, fontFamily: "JetBrains Mono, monospace" }}>Tools</div><div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>{["Excel", "Python", "Stata", "RStudio", "SQL", "PowerPoint", "Streamlit"].map(s => <span key={s} style={{ fontSize: 11, padding: "5px 12px", borderRadius: 6, background: "#080c16", color: "#94a3b8", border: "1px solid #1e293b" }}>{s}</span>)}</div></div>
        </div>
        <div className="dash-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 18 }}>
          <div style={S.card}>
