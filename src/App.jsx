...
const PROJECTS = [
  ...
  { title: "Take-Private LBO — Electronic Arts ($55B)", desc: "Led a graduate deal team on a hypothetical $55B all-cash take-private of EA — 38-page investment memorandum, 24-slide IC pitch deck, and 12-tab Excel LBO model built from primary SEC filings. Three-case operating projections deriving 1.27x–2.43x MoM and 4.8%–19.4% gross IRR, five-method football field, and full value-creation bridge. Selected by course faculty as the reference standard for future iterations.", tags: ["LBO", "Private Equity", "Excel", "Pitch Deck"], status: "Completed", completed: "May 2026" },
  { title: "Sponsor-to-Sponsor LBO — Jagex (£900M)", desc: "Cross-border buyout of Jagex (RuneScape) — £900M / $1.1B acquisition modeled at a 13.4x FY23 EBITDA entry from PwC-audited Companies House accounts. 10-tab LBO model, 26-page investment memorandum, quality-of-earnings bridge ($56.4M reported to $75M pro-forma EBITDA), and a full PE fund waterfall underwriting a 1.77x MOIC / 12.1% sponsor IRR base case.", tags: ["LBO", "Private Equity", "Excel", "Secondary Buyout"], status: "Completed", completed: "May 2026" },
        ...
        <div style={{ ...S.card, background: "linear-gradient(135deg,#f6eee1,#fdf8f0,#f6eee1)", border: "none", borderRadius: 16, position: "relative", overflow: "hidden" }}>
          ...
          <div className="bio-layout" style={{ display: "flex", gap: 28, alignItems: "flex-start", flexWrap: "wrap", position: "relative" }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ color: "#4a443c", fontSize: 14, lineHeight: 1.85, marginBottom: 18 }}>M.S. Finance graduate (May 2026, 4.0 GPA) from the Sam M. Walton College of Business, based in Dallas–Fort Worth. Deal-team experience spanning a $55B take-private LBO and a £900M sponsor-to-sponsor buyout, plus sector analysis for a $700K+ student-managed fixed-income fund. Bloomberg Market Concepts certified, FINRA SIE in progress. Pursuing investment banking, private equity, wealth management, and corporate finance roles.</p>
